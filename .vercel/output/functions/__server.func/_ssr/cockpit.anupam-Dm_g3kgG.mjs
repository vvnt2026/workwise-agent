...
import { C as CockpitShell, d as anupamNav, M as MorningBriefing, a as ControlTower, A as AIInsight, b as AgentActivity, c as AttentionList, H as HRCopilot } from "./CockpitSections-BlFOd_-a.mjs";
...
function Page() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(CockpitShell, { persona: {
    initials: "AS",
    ...
    location: "Pune",
    navGroups: anupamNav,
    widgets: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-wider text-sidebar-foreground/40 font-semibold mb-2", children: "Group scope" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[11px] text-sidebar-foreground/70 space-y-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "BFL · 53,420" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Bajaj Life · 28,100" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "BGI · 12,800" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "AMC · 1,240" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Alts · 580" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Health · 6,200" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Markets · 2,328" })
      ] })
    ] })
  }, personaSlug: "anupam", headerCenter: "Anupam Sirbhaiya · Group CHRO · Bajaj Finserv Limited", contextStrip: "Good morning, Anupam — 3 group-level signals and 1 strategic priority need your attention today.", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(MorningBriefing, { children: "Group workforce at 1,04,668 across 7 entities. Three signals need your read today: AMC attrition running 5pp above group average with niche talent exiting to Mirae and Nippon; post-Allianz pulse trust score slipped 0.3 points MoM to 6.4 — Finance function the fastest declining; and 4,200 IRDA agent licences lapsing in 90 days with renewal sprint at 61%. BFL field attrition holding at 14.9% — your one green signal today." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ControlTower, { kpis: [{
      label: "Group workforce",
      value: "1,04,668",
      sub: "Across 7 entities",
      detail: {
        ...
        table: {
          ...
          rows: [["Bajaj Finance", "53,420", "+4.1%", "14.9%"], ["Bajaj Life Insurance", "28,100", "+2.8%", "21.4%"], ["Bajaj General Insurance", "12,800", "+5.6%", "17.2%"], ["Bajaj Finserv Health", "6,200", "+22.0%", "19.8%"], ["Bajaj Markets", "2,328", "+9.1%", "16.4%"], ["Bajaj Finserv AMC", "1,240", "+38.0%", "11.2%"], ["Bajaj Alts", "580", "+24.5%", "9.6%"]]
        },
        actions: ["Export to board pack", "Send to Sanjiv", "Open entity drill"]
      }
    }, {
      label: "Group attrition",
      value: "16.4%",
      sub: "vs BFSI 18.2%",
      tone: "healthy",
      detail: {
        headline: "Group attrition 16.4% · 180 bps below BFSI peer median",
        bullets: ["Best-in-class: Bajaj Alts (9.6%) and AMC (11.2%) — small specialist cohorts.", "Worst: Bajaj Life agency 31.2% (industry 34%) and Health 19.8% (rapid scale-up)."]
      }
    }, {
      ...
      tone: "warning",
      detail: {
        headline: "Internal mobility 4.1% · target 6% by FY27"
      }
    }, {
      label: "Leadership bench strength",
      value: "71%",
      sub: "Group governance layer · target 85%",
      tone: "warning",
      detail: {
      ...
      label: "Succession · CXO",
      value: "8 / 14",
      sub: "Roles with ready-now",
      tone: "warning",
      detail: {
        headline: "8 of 14 CXO roles have a ready-now successor",
        bullets: ["Bajaj Life accounts for 3 of the 6 uncovered roles.", "Average successor readiness = 19 months — above target 12."]
      }
    }, {
      label: "Time-to-Productivity",
      value: "68 d",
      sub: "New hire to full output · Target 55 d",
      tone: "warning",
      detail: {
        headline: "Group TTP 68 days · 13 days above target"
      }
    }, {
      label: "Internal Fill Rate",
      value: "41%",
      sub: "Roles filled internally · Target 55%",
      tone: "warning",
      detail: {
        headline: "Internal fill rate 41% · target 55%"
      }
    }] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(AIInsight, { title: "Finance function trust declining — intervention window is now", body: "Post-Allianz pulse shows Finance function trust at 6.1/10 and the only function declining (−0.1 MoM). All other functions are flat or improving. Finance teams typically show this pattern when role clarity and comp parity remain unresolved post-merger. Historical data from 3 comparable insurance integrations shows trust recovers in 90 days with targeted intervention — or falls below 5.5 within 6 months without it. You are in the intervention window. Recommended: 30-day Finance function town hall + role clarity workshop + comp parity audit. Cost: low. Window: 60 days.", confidence: "81–87%", sources: ["Post-Allianz pulse data", "BFSI merger integration benchmarks", "Finance function sentiment trends"], drill: {
      ...
      table: {
        ...
        rows: [["Finance", "6.1", "↓0.1", "Role clarity"], ["Bancassurance", "6.4", "↑0.2", "Slow integration"], ["Agency", "7.1", "↑0.6", "Improving fastest"], ["HR", "7.2", "↑0.3", "Stable"], ["Claims (BAGIC)", "7.3", "↑0.5", "Stable"], ["Tech", "7.8", "↑0.4", "Most settled"]]
      },
      bullets: ["Comparable insurance merger benchmarks (HDFC-ERGO, ICICI-Pru) show 60-day intervention window before trust hardens.", "30-day Finance town-hall + role clarity workshop cost: ~₹18L.", "Cost of inaction modelled: 11–14% Finance attrition over 6 months ≈ ₹3.4 Cr."],
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AIInsight, { title: "1,180 DST→RM promotions stalled — FY26 target miss risk", body: "DST→RM progression backlog stands at 1,180 candidates who have met performance criteria but are awaiting promotion interview scheduling. Average wait: 47 days past eligibility. BFL field attrition data shows that eligible-but-not-promoted DSTs have 2.3× higher 90-day exit rate vs promoted peers. At current backlog pace, approximately 280 of the 1,180 will exit before promotion — losing trained talent at the exact moment they peak. Recommended: emergency interview sprint — 5 days, dedicated panel, clear 48-hour decision SLA. Saves estimated ₹1.07 Cr in replacement costs.", confidence: "87–93%", sources: ["HRMS promotion pipeline", "BFL attrition cohort model", "Promotion-lag exit correlation"], drill: {
      ...
      table: {
        ...
        rows: [["West (Pune HQ)", "412", "52 d", "98"], ["South", "284", "49 d", "68"], ["North", "236", "44 d", "54"], ["East", "158", "41 d", "36"], ["Central (MP)", "90", "38 d", "24"]]
      },
      bullets: ["Promoted DSTs show 14% productivity uplift in first 60 days — backlog is suppressing zone output.", "5-day interview sprint with 4 parallel panels can clear the backlog in 9 working days.", "Replacement cost per exited DST ≈ ₹38,000 (sourcing + ramp). 280 exits ≈ ₹1.07 Cr saved."],
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AIInsight, { title: "BGI claims comp gap creating a poaching corridor", body: "Claims analyst roles at BAGIC are paying 8% below market median. Three competitors (HDFC Ergo, ICICI Lombard, New India) have active lateral hiring campaigns targeting exactly this profile — 3–6 years experience, non-life claims, Pune/Mumbai location. BAGIC claims has 320 open roles and a current team showing 16.1% attrition. The comp gap is the only structural driver — manager scores and culture scores are healthy. A targeted 8% correction for claims analyst band costs approximately ₹1.8 Cr annually. The attrition replacement cost at current pace: ₹3.2 Cr. Recommended: approve claims analyst comp correction in next compensation review cycle. Flag to BAGIC CHRO for immediate action.", confidence: "84–90%", sources: ["Market comp benchmarks", "Competitor hiring intelligence", "BAGIC attrition model"], drill: {
      headline: "BGI claims analyst pay 8% below market — active poaching from 3 competitors",
      table: {
        cols: ["Band", "BAGIC", "Market P50", "Gap"],
        rows: [["Claims Analyst L1", "₹5.8L", "₹6.3L", "-7.9%"], ["Claims Analyst L2", "₹7.6L", "₹8.4L", "-9.5%"], ["Senior Claims Analyst", "₹11.2L", "₹12.1L", "-7.4%"], ["Claims Manager", "₹16.8L", "₹17.6L", "-4.5%"]]
      },
      bullets: ["Active competitor JDs scraped from LinkedIn last 14 days: HDFC Ergo 38, ICICI Lombard 41, New India 22.", "Pune + Mumbai location filter — 71% match to BAGIC current footprint.", "Manager NPS and culture scores in BAGIC claims are healthy (+44, 7.6) — comp is the only lever."],
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AgentActivity, { runs: [{
      agent: "Succession Agent",
      message: "Flagged 3 CXO-1 roles at Bajaj Life with no ready-now successor.",
      time: "02:14"
    }, {
      agent: "Compliance Agent (SEBI/IRDAI)",
      message: "Q1 board reporting pack drafted; 2 anomalies flagged.",
      time: "03:01"
    }, {
      agent: "Culture Integration Agent",
      message: "Post-Allianz pulse: trust score 6.4/10, down 0.3 MoM.",
      time: "03:42"
    }, {
      agent: "Skills Agent",
      message: "AMC & Alts hiring gap: 240 niche roles, 31% closed.",
      time: "04:18"
    }, {
      agent: "Attrition Agent",
      message: "BFL field attrition trending 14.9%, within FY benchmark.",
      time: "04:55"
    }, {
      agent: "Compensation Benchmarking Agent",
      message: "BGI claims roles 8% below market median.",
      time: "05:30"
    }, {
      agent: "Licensing Agent",
      message: "IRDA licence lapses next 90 days: 4,200 agents.",
      time: "06:02"
    }, {
      agent: "Field Performance Agent",
      message: "DST→RM progression backlog: 1,180 candidates.",
      time: "06:21"
    }] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(AttentionList, { items: [{
      priority: "critical",
      title: "Bajaj Life CXO-1 succession gap",
      ...
      drill: {
        ...
        bullets: ["Chief Distribution Officer — incumbent in role 22 months, regretted-attrition risk Medium.", "Appointed Actuary — regulatory role; replacement timeline 6-9 months even with external search.", "Head Bancassurance — succession plan exists but candidate is in BFL, not Bajaj Life."],
        table: {
          cols: ["Role", "Incumbent tenure", "Internal bench", "External search"],
          rows: [["Chief Distribution Officer", "22 mo", "0", "Egon Zehnder · 60 d in"], ["Appointed Actuary", "34 mo", "0", "Spencer Stuart · 90 d in"], ["Head Bancassurance", "11 mo", "0 at BALIC · 1 at BFL", "Internal slate first"]]
        },
      ...
      priority: "warning",
      title: "Post-Allianz integration opportunity",
      ...
      drill: {
        ...
        bullets: ["Tech and Claims have crossed the 7.0 stability threshold.", "Bancassurance trust stalled at 6.4 — pulse cites brand confusion (Bajaj Life vs Bajaj Allianz Life).", "Brand transition complete on signage; in-customer collateral migration at 78%."],
      ...
      drill: {
        ...
        bullets: ["Hardest roles: Quant PMs (12 open), Credit analysts for Alts (24 open), Compliance lead (3 open).", "Pipeline below target — only 1.8 qualified candidates per role.", "Compensation 11% below boutique fund benchmark."],
        table: {
          cols: ["Function", "Open", "Filled", "Avg TTH"],
          rows: [["AMC · Quant PMs", "12", "3", "112 d"], ["AMC · Equity Analyst", "38", "14", "76 d"], ["Alts · Credit Analyst", "24", "6", "98 d"], ["Compliance · Senior", "3", "0", "140 d"]]
        },
      ...
      priority: "warning",
      title: "4,200 IRDA agent licences lapsing",
      ...
      drill: {
        ...
        table: {
          ...
          rows: [["West", "1,840", "4,420", "58%"], ["South", "1,120", "3,180", "54%"], ["North", "780", "2,140", "67%"], ["East", "460", "1,460", "71%"]]
        },
        bullets: ["₹340 Cr APE attached to these 4,200 agents (avg ₹8.1L APE/agent).", "Module completion via mobile micro-cohorts can cut wait time 38%.", "IRDAI penalty exposure if any cohort lapses without action."],
      ...
      priority: "warning",
      title: "BGI claims compensation gap",
      ...
      drill: {
        ...
        bullets: ["Comp gap is the only structural driver — manager NPS +44, culture 7.6.", "Annual cost to close: ~₹1.8 Cr · replacement cost if unaddressed: ~₹3.2 Cr.", "Pune + Mumbai cohort (71% of HAT footprint) most exposed."],
      ...
      priority: "healthy",
      title: "BFL field attrition 14.9%",
      ...
      drill: {
        ...
        bullets: ["180 bps below BFSI peer median (18.2%).", "Largest gain: Pune zone (15.2% → 12.8% in 5 months).", "Pattern to document: 1-manager-per-12-SO ratio + 30-day promotion SLA."],
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(HRCopilot, { personaName: "Anupam", prompts: [{
