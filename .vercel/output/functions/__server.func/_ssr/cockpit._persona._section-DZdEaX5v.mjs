...
import { e as personaRegistry, s as slugify, C as CockpitShell, a as ControlTower, A as AIInsight, c as AttentionList, b as AgentActivity, H as HRCopilot } from "./CockpitSections-BlFOd_-a.mjs";
import { R as Route } from "./router-B_dKPYL5.mjs";
...
function SectionPage() {
  ...
  if (!meta) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen flex items-center justify-center text-muted-foreground", children: "Persona not found." });
  }
  let item;
  let heading = "";
  ...
  if (!item || !item.detail) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(CockpitShell, { persona: personaProps, personaSlug: meta.slug, headerCenter: `${meta.name} · Section not found`, contextStrip: "The section you're looking for hasn't been wired up yet.", accent: meta.accent, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white border border-border rounded-lg p-8 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[14px] font-semibold mb-2", children: "Section not found" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[12.5px] text-muted-foreground mb-4", children: [
        '"',
        section,
        `" isn't a valid view under `,
        meta.name,
        "'s cockpit."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/cockpit/$persona", params: {
        persona: meta.slug
      }, className: "text-[12.5px] font-semibold text-[#1a56db]", children: "← Back to cockpit" })
    ] }) });
  }
  const d = item.detail;
  ...
  if (override?.kpis && override.kpis.length > 0) {
    ...
    d.table.rows.slice(0, 4).forEach((r) => {
  ...
  if (override?.attention && override.attention.length > 0) {
    ...
    const priorities = ["critical", "warning", "warning", "healthy"];
    attention = d.actions.slice(0, 4).map((a, i) => ({
  ...
  const insight = override?.insight ?? d.aiInsight ?? {
    ...
    body: typeof d.narrative === "string" ? d.narrative : d.bullets?.join(" ") ?? d.headline,
    confidence: "84–91%",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(CockpitShell, { persona: personaProps, personaSlug: meta.slug, headerCenter: `${item.label} · ${meta.name}`, contextStrip: `${heading} → ${item.label} · live cockpit view`, accent: meta.accent, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[11px] uppercase tracking-wider text-muted-foreground font-semibold", children: [
          heading,
          " → ",
          item.label,
          " · June 2026"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-[24px] font-semibold mt-1 flex items-center gap-2", children: [
          item.icon && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: item.icon }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: item.label })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[13.5px] text-muted-foreground mt-1 max-w-2xl", children: d.headline })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/cockpit/$persona", params: {
        persona: meta.slug
      }, className: "text-[12px] font-semibold text-[#1a56db] hover:underline whitespace-nowrap", children: [
        "← Back to ",
        meta.name.split(" ")[0],
        "'s cockpit"
      ] })
    ] }),
    kpis.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(ControlTower, { kpis, accent: meta.accent }),
    d.table && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "bg-white border border-border rounded-lg p-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-title mb-3", children: [
        "Detail breakdown · ",
        item.label
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border border-border rounded-lg overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-[12.5px]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-muted/60", children: /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: d.table.cols.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left font-semibold px-3 py-2 text-muted-foreground uppercase text-[10.5px] tracking-wider", children: c }, c)) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: d.table.rows.map((r, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { className: "border-t border-border hover:bg-muted/20", children: r.map((cell, j) => /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2 tabular-nums", children: cell }, j)) }, i)) })
      ] }) })
    ] }),
    d.bullets && d.bullets.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "bg-white border border-border rounded-lg p-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-title mb-3", children: "Key signals" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: d.bullets.map((b, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2 text-[13px] text-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mt-1.5 w-1.5 h-1.5 rounded-full shrink-0", style: {
          background: meta.accent
        } }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: b })
      ] }, i)) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(AIInsight, { title: insight.title, body: insight.body, confidence: insight.confidence, sources: insight.sources, accent: meta.accent, drill: insight.drill ?? d }),
    attention.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(AttentionList, { items: attention, accent: meta.accent }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(AgentActivity, { runs: agentRuns }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(HRCopilot, { personaName: meta.name.split(" ")[0], prompts: meta.prompts, accent: meta.accent })
  ] });
}
export {
