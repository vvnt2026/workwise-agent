...
import { C as CockpitShell, r as rohitNav, M as MorningBriefing, a as ControlTower, A as AIInsight, b as AgentActivity, c as AttentionList, H as HRCopilot } from "./CockpitSections-BlFOd_-a.mjs";
...
function Page() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(CockpitShell, { persona: {
    ...
    widgets: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-wider text-sidebar-foreground/40 font-semibold mb-2", children: "Zone" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[11px] text-sidebar-foreground/70 space-y-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Headcount · 32,140" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Branches · 412" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Verticals · Consumer · SME · Rural" })
      ] })
    ] })
  }, personaSlug: "rohit", headerCenter: "Rohit Kapoor · HRBP Field Sales · BFL West India", contextStrip: "Good morning, Rohit — 42 Sales Officers in Pune & Nashik zone are showing burnout signals. Cost of inaction this month: ₹1.9 Cr.", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(MorningBriefing, { children: "Morning, Rohit. Three signals need your decision today. 42 SOs in Pune and Nashik have hit triple burnout criteria — the intervention window closes in 7 days before exit risk doubles. Kavya Sharma in Nashik East is your highest flight-risk at score 94, with a manager who has not done a 1:1 in 38 days. And 184 DSTs in Pune zone have cleared promotion criteria but are stuck waiting for interview scheduling — each extra week costs you 4 exits from that cohort statistically." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ControlTower, { kpis: [{
      ...
      detail: {
        ...
        table: {
          ...
          rows: [["Consumer lending", "18,420", "236", "+3.1%"], ["SME finance", "7,840", "112", "+5.8%"], ["Rural B2C", "5,880", "64", "+18.4%"]]
        },
        actions: ["Export to MIS", "Drill by branch"]
      }
    }, {
      label: "Field attrition",
      value: "14.9%",
      sub: "FY24 · vs 17.1% LY",
      tone: "healthy",
      detail: {
      ...
      label: "Manager NPS",
      value: "+38",
      sub: "Tier 3 cities low",
      detail: {
        headline: "Manager NPS +38 overall · Tier-3 at +12",
        bullets: ["Tier-1 +52 (best in 6 quarters)", "Tier-2 +34", "Tier-3 +12 — coaching investment needed"]
      }
    }, {
      label: "Incentive accuracy",
      value: "99.4%",
      sub: "Last payout cycle",
      tone: "healthy",
      detail: {
        headline: "99.4% accuracy · zero escalations last cycle",
        bullets: ["Up from 96.8% three cycles ago.", "Driven by new payout engine and reconciliation agent."]
      }
    }] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(AIInsight, { title: "Manager NPS gap is costing you ₹3.1 Cr — and it has one fix", body: "You have 7 branch managers across Nashik, Aurangabad and Jabalpur with NPS below +22. These 7 managers collectively cover 4,180 SOs. Their teams show 22.4% attrition vs 11.8% for managers with NPS above +40. The gap is not personality — it is coaching cadence. All 7 managers have done fewer than 1 structured 1:1 per month with their team leads. A 6-week coaching sprint for these 7 managers (external facilitation + peer shadowing) costs ₹1.4L. The attrition saving from closing the gap: ₹3.1 Cr at current replacement cost. This is your highest ROI action this quarter.", confidence: "83–89%", sources: ["Manager NPS survey", "Login telemetry", "Attrition cohort correlation model"] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(AIInsight, { title: "184 promotion-eligible DSTs are 38 days past their SLA — 4 will exit this week", body: "Promotion pipeline shows 184 DSTs in Pune zone who met all criteria 38+ days ago but have not had a promotion interview scheduled. Internal data shows DSTs who wait more than 30 days post-eligibility have 2.3× higher exit probability in the following 30 days. Based on this model, 4 exits from this cohort are expected this week if no action is taken. Each exit from a promotion-ready DST costs ₹52,000 in replacement and ramp — but more critically, these are your best-performing field staff, not average. Recommended: emergency interview panel — 2 days, 20 candidates per day. Clears the backlog in 10 days.", confidence: "86–92%", sources: ["HRMS promotion pipeline", "Exit cohort analysis", "Promotion-lag attrition model"] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(AIInsight, { title: "SME vertical incentive perception is a hidden time bomb", body: "27% of SME vertical Sales Officers — 847 employees across Pune and Nagpur — rated their last incentive payout as unfair in the monthly pulse. The specific complaint is not payout accuracy (which is 99.4%) but slab structure: the slab reset mid-quarter meant SOs who were on track for the higher tier were recategorised downward without warning. SME vertical already shows the highest attrition in the zone at 18.4%. Unfair compensation perception is the #1 predictor of exit within 60 days in BFL field data. Recommended: host a 45-minute town hall with SME vertical in Pune and Nagpur separately this week — not to change the slab, but to explain the change. Perception management costs nothing. The attrition cost of inaction: ₹2.8 Cr.", confidence: "79–85%", sources: ["Incentive pulse survey", "SME attrition model", "Exit interview reason data"] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(AgentActivity, { runs: [{
      agent: "Attrition Agent",
      message: "42 SOs flagged · Pune & Nashik · burnout cluster.",
      time: "02:08"
    }, {
      agent: "Field Performance Agent",
      message: "DST→RM progression: 184 candidates ready in Pune zone.",
      time: "02:51"
    }, {
      agent: "Compensation Benchmarking Agent",
      message: "Incentive slab perceived unfair by 27% of SMEs surveyed.",
      time: "03:34"
    }, {
      agent: "Skills Agent",
      message: "Rural B2C: 340 SOs need cross-skill into agri-finance.",
      time: "04:12"
    }, {
      agent: "Compliance Agent (SEBI/IRDAI)",
      message: "Tier-3 KYC training overdue for 612 SOs.",
      time: "04:55"
    }, {
      agent: "Succession Agent",
      message: "12 Branch Manager roles · 3 ready successors each.",
      time: "05:30"
    }, {
      agent: "Culture Integration Agent",
      message: "Manager NPS in Tier-3 down 4pts; coaching gap.",
      time: "06:05"
    }] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(AttentionList, { items: [{
      priority: "critical",
      title: "42 SOs burnout cluster · Pune/Nashik",
      ...
      priority: "critical",
      title: "612 SOs overdue on KYC training",
      ...
      priority: "warning",
      title: "2,925 open roles · time-to-fill 41 days",
      detail: "Rural expansion ramp slipping by 11 days",
      action: "Open req review",
      drill: {
        headline: "Time-to-fill 41 days vs 30 target",
        bullets: ["Rural roles slowest at 48 days.", "Branch Manager pipeline shallow — only 1.4 candidates per role.", "RPO ramp adding capacity in Q2."]
      }
    }, {
      priority: "warning",
      title: "Incentive fairness perception 27% negative",
      detail: "Cluster: SME vertical · Pune & Nagpur",
      action: "Schedule town-hall",
      drill: {
        headline: "27% of SME SOs perceive incentive slab as unfair",
        bullets: ["Concentrated in Pune & Nagpur SME branches.", "Driver: cross-sell credit unclear in slab calc.", "Recommend town-hall + slab walkthrough."]
      }
    }, {
      priority: "warning",
      title: "DST→RM progression backlog · 184",
      detail: "Pune zone · ready candidates blocked by interview SLA",
      action: "Unblock pipeline",
      drill: {
        headline: "184 DSTs ready for RM promotion · blocked",
        bullets: ["Average wait time 47 days vs 14-day SLA.", "Bottleneck: zonal interview panel availability.", "Risk: regretted-attrition spike in this cohort if delays continue."]
      }
    }, {
      priority: "healthy",
      title: "Last payout cycle 99.4% accurate",
      detail: "Zero escalations · finance sign-off received",
      action: "Acknowledge",
      drill: {
        headline: "Cleanest cycle in 18 months",
        bullets: ["Zero finance escalations.", "Cohort surveyed reported 94% satisfaction.", "Recognition prepared for payout ops team."]
      }
    }] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(HRCopilot, { personaName: "Rohit", prompts: [{
